...
def compare_sort(sizes=[100, 200, 500, 1000, 2000, 5000, 10000, 20000, 50000, 100000]):  #  10, 50, 100, 200, 500, 800
    """
    ...
    for size in sizes:
        ...
        qsort_fixed_pivot = lambda a: qsort(a, pivot_first)
        qsort_random_pivot = lambda a: qsort(a, pivot_random)
        ...
        result.append([
            ...
            time_search(sorted, mylist.copy())
        ])
    return result
    ###
